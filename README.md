...
- **Argon2id optimizado**: Parámetros configurados (memory: 64MB, iterations: 3, parallelism: 1) para máximo equilibrio entre seguridad anti-fuerza bruta y rendimiento en móviles
