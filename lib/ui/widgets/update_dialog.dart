...
///
/// En Windows ofrece descarga directa del installer.
/// En Android ofrece descarga directa del APK.
/// En otras plataformas muestra info con link a releases.
///
...
Future<UpdateDialogAction?> showUpdateDialog(
  ...
  final canAutoInstall = isDesktop || isAndroid;
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          Text(
            canAutoInstall
                ? '¿Querés descargar e instalar la nueva versión ahora?'
